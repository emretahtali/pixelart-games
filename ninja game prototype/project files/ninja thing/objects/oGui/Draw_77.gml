...
else
{
	...
	if (window_get_width() * (3 / 4) <= window_get_height())
	{
	...
	if (mouse_wheel_up()) screen_bulge_trg += .1;
	else if (mouse_wheel_down()) screen_bulge_trg -= .1;
	
	screen_bulge = lerp(screen_bulge, screen_bulge_trg, .2);
